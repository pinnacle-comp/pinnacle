...
use snowcap_api_defs::snowcap::layer::{
    self,
    v1::{CloseRequest, NewLayerRequest, NewLayerResponse, layer_service_server},
};
...
impl layer_service_server::LayerService for super::LayerService {
    async fn new_layer(
        ...
        let anchor = match anchor {
            layer::v1::Anchor::Unspecified => wlr_layer::Anchor::empty(),
        ...
        run_unary(&self.sender, move |state| {
            let Some((f, states)) = crate::api::widget::v1::widget_def_to_fn(widget_def) else {
