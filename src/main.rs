...
async fn main() -> anyhow::Result<()> {
    // FIXME: remove
    // let layout1 = pinnacle::layout::LayoutNode {
    //     row: true,
    //     flex_grow: 1.0,
    //     children: [
    //         (
    ...
    // };
    //
    // let layout2 = pinnacle::layout::LayoutNode {
    //     row: true,
    //     flex_grow: 1.0,
    //     children: [
    //         (
    ...
    // };
    //
    // let layout3 = pinnacle::layout::LayoutNode {
    //     row: true,
    //     flex_grow: 1.0,
    //     children: [
    //         (
    ...
    // };
    //
    // let mut tree = pinnacle::layout::LayoutTree::new(layout1, 0);
    // tree.compute_geos();
    //
    // println!("diffing");
    // tree.diff(layout2, 0);
    // tree.compute_geos();
    //
    // println!("diffing again");
    // tree.diff(layout3, 0);
    // dbg!(tree.compute_geos());
    //
    // return Ok(());
